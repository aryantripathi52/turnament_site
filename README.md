...
You can then access the application in your browser. You can register as a Player, or use the provided role keys during registration to access Staff or Admin functionality.

- **Player:** Register without a role key.
- **Staff:** Use the key `STAFF_DPS#1` during registration.
- **Admin:** Use the key `ADMIN_DPS#1` during registration.
