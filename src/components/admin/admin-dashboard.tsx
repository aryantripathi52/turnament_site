...
import { Gem, LayoutDashboard, User as UserIcon, Gamepad2, Coins, UserPlus, ListOrdered, PanelLeft } from 'lucide-react';
...
export function AdminDashboard() {
  ...
  const NavTabs = () => (
    <TabsList className="grid w-full grid-cols-1 md:flex md:flex-col md:h-full md:space-y-2">
        ...
        <TabsTrigger value="coin-requests" onClick={() => handleTabChange('coin-requests')} className="w-full justify-start gap-2">
        ...
        <TabsTrigger value="hire-staff" onClick={() => handleTabChange('hire-staff')} className="w-full justify-start gap-2">
